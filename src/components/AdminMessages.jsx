      ...
      >
        ...
        <div className="flex items-center justify-between p-6 border-b border-slate-700/50">
          <div className="flex items-center gap-4">
            <div className="p-3 bg-gradient-to-r from-violet-600 to-emerald-600 rounded-full">
                  ...
                  <motion.div
                    ...
                    className={`p-4 rounded-xl cursor-pointer transition-all duration-300 border ${
                      message.status === 'unread'
                        ? 'bg-violet-900/20 border-violet-500/30 hover:bg-violet-900/30'
                        : 'bg-slate-800/50 border-slate-600/30 hover:bg-slate-700/50'
                    } ${selectedMessage?.id === message.id ? 'ring-2 ring-violet-400' : ''}`}
                  >
                    <div className="flex items-start justify-between">
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center gap-2 mb-1">
                          {message.status === 'unread' ? (
                            <FaEnvelope className="text-violet-400 text-sm flex-shrink-0" />
                          ) : (
                ...
                <div className="p-6 border-b border-slate-700/50">
                  <div className="flex items-start justify-between">
                    <div className="flex-1">
                      ...
                      <p className="text-violet-400 mb-1">{selectedMessage.email}</p>
